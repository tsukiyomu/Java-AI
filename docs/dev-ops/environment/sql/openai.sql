...
CREATE TABLE openai_session (
    id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT 'SessionID',
    openid VARCHAR(64) NOT NULL COMMENT 'UserUniqueIdentifier',
...
CREATE TABLE openai_message (
    id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT 'MessageID',
